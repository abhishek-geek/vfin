        ...
        <div class="row">
            ...
            <div class="col-8 d-flex justify-content-center text-center" style="align-items :center;">
                <div class="row">
                    ...
                    include "dbconnect.php";
                    //echo $_POST['Search'];
                    $qry = 'SELECT * FROM vehicle WHERE v_id = "' . $_POST['Search'] . '" ;';
                    $qry2 = 'SELECT * FROM owner WHERE aadhar = (SELECT aadhar FROM v_owner WHERE v_id = "' . $_POST['Search'] . '");';
                    //echo var_dump($qry);
                    $result = mysqli_query($link, $qry);
                    ...
                    if (mysqli_num_rows($result) > 0 && mysqli_num_rows($result2) > 0) {
                        ...
                        echo '<div class="col-6">
                                      ...
                                      <button type="submit" name="loan" value="' . $vid . '" class="btn btn-outline-success btn-lg">Loan Details</button>
                                      </form>
                                      </div>
                                  ';
                    } else {
            ...
            <div class="col-4 d-flex justify-content-center text-center vr">
                <div class="right">
